...
<head>
   ...
   <body>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                   ...
                   <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="signup.php" style="color: white;border-bottom:2px solid white">Signup</a>
                    </li>
                </ul>
            </div>
        </div>
     ...
     <div class="container">
    <header class="text-center mb-4">Signup</header>
    <form>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="input-field mb-3 position-relative">
                    ...
                    <span  class="show position-absolute" style="right: 10px; top: 50%; transform: translateY(-50%); cursor: pointer;">SHOW</span>
                </div>
            </div>
        </div>
