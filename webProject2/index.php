                ...
                <ul class="navbar-nav">
                   ...
                   <li class="nav-item ">
                       <div class="dropdown show">
                        <a class="btn btn-secondary dropdown-toggle" style="background-color: #009688; border: none;height:42px;width:70px;text-align:center" href="#" role="button" id="dropdownMenuLink" aria-haspopup="true" aria-expanded="false">
                            Lists
                        </a>

                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="lists.php?category=Books&categ=Reading">Books</a>
                             <a class="dropdown-item" href="lists.php?category=Shows&categ=watching">Shows</a>
    ...
    <div class="hero" style="padding-bottom: 50px;padding-top: 50px;">
        <div style=" text-align: center;vertical-align: middle;">
            ...
            <div style="color: #F5F5F5;margin-bottom:10px;">
                <h1> Listify</h1>
                <h4>Your Personal Tracker for Books, Movies and Games </h4>
                ...
                <div class="row justify-content-center ">
                    ...
                    <div class="card col-lg-2 col-md-4 col-sm-4 mb-3 mx-sm-2 " style="padding:0;border-color:#8B4513; ">
                        ...
                        <div class="card-body " style="background-color:#F5F5DC ">
                            ...
                            <a href="lists.php?category=Books&categ=Reading" class="btn btn-primary" style="background-color:#007BFF; border:none;">View List</a>
                    ...
                    <div class="card col-lg-2 col-md-4 col-sm-4 mb-3 mx-sm-2 " style="padding:0;border-color:#8B0000; ">
                        ...
                        <div class="card-body " style="background-color:#F8F9FA; ">
                            ...
                            <a href="lists.php?category=Shows&categ=watching" class="btn btn-primary " style="background-color:#FF5733;border:none; ">View List</a>
                    ...
                    <div class="card col-lg-2 col-md-4 col-sm-4 mb-3 mx-sm-2 " style="padding:0;border-color:#1A1A72; ">
                        ...
                        <div class="card-body " style="background-color:#DFF6FF; ">
                            ...
                            <a href="lists.php?category=Games&categ=playing" class="btn btn-primary " style="background-color:#28A745;border:none; ">View List</a>
                    ...
                    <div class="card col-lg-2 col-md-4 col-sm-4 mb-3 mx-sm-2 " style="padding:0;border-color:#155724; ">
                        ...
                        <div class="card-body " style="background-color:#E6F4EA; ">
                            ...
                            <a href="lists.php?category=ToDo&categ=doing" class="btn btn-primary custom-button " style="background-color:#FFC107;border:none; ">View List</a>
                            </div>
                    </div>
                </div>
            </div>
